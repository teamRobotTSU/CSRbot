...
while(True):
    ...
    cv2.putText(frame, "{},{}".format(cX, cY), (cX+10,cY+10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 1)
    cv2.putText(frame, "dX: {}, dY: {}".format(dX, dY), (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (50, 255, 0), 2)
    cv2.putText(frame, "{},{}".format(int((x-cX)), int((y-cY))), (cX+10,cY+30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,255,255), 1)
